...
public class Sll extends TipoR {
	...
	public int ejecutar() {
		...
		for(int i=0;(i<(tam));i++){
			if((i+shamt)>=0){
			nueva.setBit((int)(i+shamt), p.getBit(i));
			}
		}
	...
	public String getCodificacion() {
		 String codigo;
	     codigo=setOp(0)+setR(r[1].numReg())+"00000"+setR(r[0].numReg())+this.setShamt((int)shamt)+setFunc(0);       
