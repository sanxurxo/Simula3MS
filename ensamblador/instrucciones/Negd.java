...
public class Negd extends TipoR implements PlanifDinamica{
     Registro r[]; 
     Palabra p;
     public Negd(String param[]) 
    {
this.imagSegmentado[0]="sumaPF_IF.gif";
    ...
    {
        String codigo;
        codigo=setOp(17)+setR(1)+setR(0)+setR(r[1].numReg())+setR(r[0].numReg())+setFunc(7);       
