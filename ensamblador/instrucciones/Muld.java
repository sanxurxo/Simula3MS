...
public class Muld extends TipoR implements PlanifDinamica{
     Registro r[]; 
     Palabra nada=new Palabra("nada");
     public Muld(String param[]) 
    {
this.imagSegmentado[0]="mulPF_IF.gif";
    ...
    {
        String codigo;
        codigo=setOp(17)+setR(1)+setR(r[2].numReg())+setR(r[1].numReg())+setR(r[0].numReg())+setFunc(2);       
