...
public class Ceqs extends TipoR implements PlanifDinamica{
    Registro r[];  
    long d;
    public Ceqs(String param[]) 
    {
    ...
    {
        String codigo;
        codigo=setOp(17)+setR(0)+setR(r[1].numReg())+setR(r[0].numReg())+setR(0)+setFunc(50); 
