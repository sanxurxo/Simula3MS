...
public class Sra extends TipoR {

	 private long shamt;
	 public Sra(String param[]) 
	    {
	...
	public int ejecutar() {
		...
		String signo=Integer.toString(p.getBit());
...
;
	...
	public String getCodificacion() {
		 String codigo;
	     codigo=setOp(0)+setR(r[1].numReg())+"00000"+setR(r[0].numReg())+this.setShamt((int)shamt)+setFunc(3);       
