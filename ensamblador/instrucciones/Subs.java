...
public class Subs extends TipoR  implements PlanifDinamica{
    Registro r[]; 
    public Subs(String param[]) 
    {
...
//        Double result=new Double(resultado);
//        Palabra res=new Palabra(resultado);
//        
//        String rest=res.dec_a_float(result,"SP");
...
//        double resultado=r[1].getPalabra().getFrac()-r[2].getPalabra().getFrac();
     ...
     public int etapa3()
    {
        ...
        double resultado=r[1].getPalabra().getDec()-r[2].getPalabra().getDec();
        return -1;
    }
    ...
    {
        String codigo;
        codigo=setOp(17)+setR(0)+setR(r[2].numReg())+setR(r[1].numReg())+setR(r[0].numReg())+setFunc(1);       
