...
public class Beq extends SaltoCondicional {

    Registro r[]; 
    String etiqueta;
    private int posIns;
    public Beq(String param[], int p)
    {
    	esSalto=true;
    ...
    public int etapa3()
    {
        ...
        if(r[0].getPalabra().getHex().equals(r[1].getPalabra().getHex()))
        {
            ...
            Pc.getRegistro().modificar(i);
            boolean_pc=true;
            imagen_etapa.append(direccion_multi).append("beq");        
        }
        else
            imagen_etapa.append(direccion_multi).append("beq_no");        
        return -1;   
    ...
    {        
        ...
        String codigo;
        codigo=setOp(4)+setR(r[0].numReg())+setR(r[1].numReg())+setIn(offset);       
