...
public class Cles extends TipoR implements PlanifDinamica {
    Registro r[]; 
    long d;
    public Cles(String param[]) 
    {
this.imagSegmentado[0]="sumaPF_IF.gif";
    ...
    {
        String codigo;
        codigo=setOp(17)+setR(0)+setR(r[1].numReg())+setR(r[0].numReg())+setR(0)+setFunc(62);
