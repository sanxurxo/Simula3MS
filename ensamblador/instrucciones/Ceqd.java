...
public class Ceqd extends TipoR implements PlanifDinamica {
    Registro r[]; 
    long d;
    String s1,s2;
    double d1,d2;
    Palabra p=new Palabra("p");
    public Ceqd(String param[]) 
    {
this.imagSegmentado[0]="sumaPF_IF.gif";
    ...
    {
        String codigo;
        codigo=setOp(17)+setR(1)+setR(r[1].numReg())+setR(r[0].numReg())+setR(0)+setFunc(50); 
