...
public class Cvtws extends TipoR implements PlanifDinamica {
     Registro r[];
     double d;
     long i;
     public Cvtws(String param[]) 
    {
    ...
    {
        String codigo;
        codigo=setOp(17)+setR(0)+setR(0)+setR(r[1].numReg())+setR(r[0].numReg())+setFunc(36);       
